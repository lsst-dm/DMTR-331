...
% using template at /Users/womullan/anaconda3/envs/docsteady-env/lib/python3.7/site-packages/docsteady/templates/tpr.latex.jinja2.
...
\multicolumn{2}{p{10.9cm}}{\textbf{ LDM-503-EFDb: Replication of Summit EFD to USDF }} & Draft \\\hline
...
=======
\multicolumn{2}{p{10.9cm}}{\textbf{ LDM-503-EFDb: Replication of Summit EFD to USDF }} & Not Executed \\\hline
>>>>>>> dbb8c6e (Update from JIRA.)
...
=======
Log in to whatever VPNs are necessary to access to the Notebook Aspect
of the RSP at NCSA
...
\url{https://lsst-lsp-stable.ncsa.illinois.edu/nb/} .\\
>>>>>>> dbb8c6e (Update from JIRA.)
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
\includegraphics[width=3.12500in]{jira_imgs/3911.png}
...
Notebook Aspect of the RSP is not only possible but
straightforward.\\[2\baselineskip]This test case provides partial
coverage of the requirement DMS-NB-REQ-0023, Access to All Data
Products: ``An authorized user of the Notebook Aspect shall be able to
access the Transformed Engineering and Facilities Database (EFD) and and
all other LSST released data products.'', as adapted to the current
design for EFD replication and access (see
\href{https://dmtn-082.lsst.io}{DMTN-082}). ~Note that it is still also
anticipated that TAP access to the EFD will be provided in the RSP as an
alternative to the Python-API access covered by this test case. ~Note in
particular that this test case does not cover the feature of the
``Transformed'' EFD from the original design in which EFD data is
...
\includegraphics[width=3.12500in]{jira_imgs/3922.png}\\
\includegraphics[width=3.12500in]{jira_imgs/3920.png}
...
the test report
(\textbackslash{}secref\{sec:LVV-T2339nb\})\\[2\baselineskip]
