...
\multicolumn{2}{p{10.9cm}}{\textbf{ DM-503-EFDb: Replication of Summit EFD to USDF }} & Approved \\\hline
...
values in the summit EFD over a specified time range and set of topics.
